...
<!-- saved from url=(0053)http://115.28.221.99/shopv3/html/setting/account.html -->
<html class="w3c">
<%@ include file="/WEB-INF/commons/head-commons.jsp" %>
<body>
<div id="header">
    <h1><img src="./account_files/logo.png"></h1>
</div>
<div id="topnav">
    <div class="navbar navbar-inverse">
        ...
        <div class="nav-collapse collapse">
            ...
            <ul class="nav">
                ...
                <a href="http://115.28.221.99/shopv3/html/setting/account.html#takeClothes" data-toggle="modal">
                    <li class=""><i class="icon icon-inbox"></i><span>顾客取衣</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/setting/account.html#recharge" data-toggle="modal">
                    <li class=""><i class="icon icon-user"></i><span>会员充值</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/setting/account.html#others" data-toggle="modal">
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group" style="width: auto; margin: 0px;">
        ...
        <li class="btn dropdown" id="edit-users">
            <a href="http://115.28.221.99/shopv3/html/setting/account.html#" data-toggle="dropdown" data-target="#edit-users" class="dropdown-toggle"><i class="icon icon-user"></i>
...
<div id="sidebar">
    <ul style="display: block;">
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/setting/account.html#"> <i class="icon icon-check"></i> <span>日常业务</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html">
                    接收衣物 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/account.html#takeClothes" data-toggle="modal">
                    顾客取衣 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/account.html#recharge" data-toggle="modal">
                    会员充值 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/account.html#others" data-toggle="modal">
                    其他消费 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/account.html#change" data-toggle="modal">
                    换卡补卡 </a></li>
        ...
        <li class="submenu"><a href="http://115.28.221.99/shopv3/html/setting/account.html#"> <i class="icon icon-financial"></i> <span>业务管理</span></a>
            <ul>
        ...
        <li class="submenu"><a href="http://115.28.221.99/shopv3/html/setting/account.html#"> <i class="icon icon-th"></i> <span>统计管理</span></a>
            <ul>
                <li><a href="http://115.28.221.99/shopv3/html/shop/shopStatistics.html">
                    门店统计</a></li>
            </ul>
        </li>
        <li class="active submenu open"><a href="http://115.28.221.99/shopv3/html/setting/account.html#"> <i class="icon icon-cog"></i> <span>系统管理</span></a>
            <ul>


                <li class="active"><a href="http://115.28.221.99/shopv3/html/setting/account.html">
                    账号管理</a></li>
...
<div id="content">
    <div class="container-fluid">
        <div class="table_info_box member-topbg">
            ...
            <input id="searchkey" placeholder="用户名" class="span3" type="text">
                            ...
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen1">    <a href="http://115.28.221.99/shopv3/html/setting/account.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table role="grid" id="DataTables_Table_0" class="table table-hover data-table dataTable no-footer">
                                ...
                                <tr role="row"><th aria-label="
                                    ...
                                    ：激活排序列升序" style="width: 77px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">登录名 <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    ...
                                    ：激活排序列升序" style="width: 77px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">角色<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                        折扣
                                        
                                    ：激活排序列升序" style="width: 56px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">折扣<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                        创建时间
                                        
                                    ：激活排序列升序" style="width: 194px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">创建时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                        操作
                                        
                                    ：激活排序列升序" style="width: 199px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td><a href="http://115.28.221.99/shopv3/html/setting/account.html#account1" data-toggle="modal" v="114606" class="btn btn-warning btgo">编辑</a>
                                        <a href="http://115.28.221.99/shopv3/html/setting/account.html#add-4" v="114606" data-toggle="modal" class="btn btn-danger btgo ">删除</a></td>
                                </tr></tbody>
...
<div id="add-4" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn btgo" href="http://115.28.221.99/shopv3/html/setting/account.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary del" href="http://115.28.221.99/shopv3/html/setting/account.html#">确 定</a></div>
</div>
<!--编辑-->
<div id="account1" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3><i class="icon icon-plus-sign"></i>用户</h3>
    </div>
    <div class="modal-body">
        <div class="row-fluid">
            <form action="http://115.28.221.99/shopv3/html/setting/account.html#" method="get" class="form-horizontal">
                <div class="span12">
                    ...
                    <div class="controls">
                        <input type="text" name="name" id="" value=""></div>

                    <label class="control-label">密码</label>

                    <div class="controls">
                        <input type="password" name="name" id="name" value=""></div>
                    ...
                    <div class="controls">
                        <div class="col-sm-10" style="width: 400px">
                            ...
                            <div class="checkbox i-checks" style="float: left;width: 130px">
                                ...
                                <div style="position: relative;" class="icheckbox_square-green"><div class="checker" id="uniform-undefined"><span><input style="position: absolute; opacity: 0;" value="4" name="areaId" type="checkbox"></span></div>
                            ...
                            <div class="checkbox i-checks" style="float: left;width: 130px">
                                ...
                                <div style="position: relative;" class="icheckbox_square-green"><div class="checker" id="uniform-undefined"><span><input style="position: absolute; opacity: 0;" value="153" name="areaId" type="checkbox"></span></div>
                                    <ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins>
                                </div>
                                客服
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn btgo" href="http://115.28.221.99/shopv3/html/setting/account.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary " href="http://115.28.221.99/shopv3/html/setting/account.html#">确 定</a></div>
</div>
<!--整体页面结束，以下是弹出窗口-->
<!--编辑条形码-->
<div id="barcode" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a class="btn btn-primary" href="javascript:;" id="export">确定</a> <a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/account.html#">取消</a></div>
</div>
&lt;<!--顾客取衣-->
<div id="takeClothes" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
                            ...
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="btn-group pull-right" style="margin-top:6px; margin-right:6px;">
                                        <a href="http://115.28.221.99/shopv3/html/setting/account.html#add-2" role="button" data-toggle="modal" class="btn  btn-danger" title="">补打小票</a>
                                        <a href="http://115.28.221.99/shopv3/html/setting/account.html#leftmoney" role="button" data-toggle="modal" class="btn btn-success" title="">顾客取衣</a>
                                    </div>
                                </div>
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        ...
                                        <table role="grid" id="DataTables_Table_0" class="table table-hover  no-footer">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>有腰带</td>
                                                <td><a href="http://115.28.221.99/shopv3/html/setting/account.html#order-flow" data-toggle="modal" v="114606" class="tab-link btgo">0090008</a></td>
                                                <td>普洗</td>
                                                <td>洗涤</td>
                                                <td>12</td>
                                            </tr>
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/account.html#">取&nbsp;&nbsp;消</a></div>
</div>
<!--部分取衣提示-->
<div id="part" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/account.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" href="http://115.28.221.99/shopv3/html/setting/account.html#">确 定</a></div>
</div>
<!--确认付款-->
<div id="add-5" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/account.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" data-toggle="modal" href="http://115.28.221.99/shopv3/html/setting/account.html#check-order">确 定</a>
    </div>
</div>
<!--欠款补齐页面-->
...
<div id="check-order" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div class="modal-body">
        <div class="row-fluid">
            <div class="span12">
                <div class="span3">
                    <a href="http://115.28.221.99/shopv3/html/setting/account.html#" data-toggle="modal" v="114606" style="margin-left:185px;" class="btn btn-success ">打印小票</a>
                ...
                <div class="span9">
                    <a href="http://115.28.221.99/shopv3/html/setting/account.html#" data-toggle="modal" v="114606" style="margin-left:765px;" class="btn btn-success ">打印条形码</a>
    ...
    <div class="modal-footer"><a class="btn btn-danger save" href="http://115.28.221.99/shopv3/html/setting/account.html#order-refund" data-toggle="modal">退款</a><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/account.html#">取消</a>
    </div>
</div>
<!--订单在工厂状态-->
                                ...
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left"><span class="text-Voucher">2</span>元（1张）
                                            <a href="http://115.28.221.99/shopv3/html/setting/account.html#" data-toggle="collapse" data-target="#change" class="btn btn-mini">点击查看</a>
                        ...
                        <div class="widget-box mt-0">
                            ...
                            <div style="margin-top: 10px;">
                                <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px">
                                    <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/setting/account.html#clubcard" data-toggle="tab">会员卡</a>
                                    </li>
                                    <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/setting/account.html#rechargecard" data-toggle="tab">充值卡</a>
                                    </li>
                                </ul>
                            </div>
                            <!--切换显示内容-->
                    ...
                    <div class="span12">
                        ...
                        <div class="span4">
                            <div class="widget-box mt-0">
                                ...
                                <div style="margin-top: 10px;">
                                    <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px;">
                                        <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/setting/account.html#c" data-toggle="tab">换&nbsp;&nbsp;卡</a>
                                        </li>
                                        <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/setting/account.html#b" data-toggle="tab">补&nbsp;&nbsp;卡</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--切换显示内容-->

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0051)http://115.28.221.99/shopv3/html/setting/frame.html -->
<html>
<%@ include file="/WEB-INF/commons/head-commons.jsp" %>
<body class="pace-done mini-navbar">

<div id="header">
    <h1><img src="./frame_files/logo.png"></h1>
</div>
<div id="topnav">
    <div class="navbar navbar-inverse">
        ...
        <div class="nav-collapse collapse">
            ...
            <ul class="nav">
                ...
                <a href="http://115.28.221.99/shopv3/html/setting/frame.html#takeClothes" data-toggle="modal">
                    <li class=""><i class="icon icon-inbox"></i><span>顾客取衣</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/setting/frame.html#recharge" data-toggle="modal">
                    <li class=""><i class="icon icon-user"></i><span>会员充值</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/setting/frame.html#others" data-toggle="modal">
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group" style="width: auto; margin: 0px;">
        <li class="btn dropdown" id="edit-users">
            <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" data-toggle="dropdown" data-target="#edit-users" class="dropdown-toggle"><i class="icon icon-user"></i>
...
<div id="sidebar">
    <ul style="display: block;">
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/setting/frame.html#"> <i class="icon icon-check"></i> <span>日常业务</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html">
                    接收衣物 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html#takeClothes" data-toggle="modal">
                    顾客取衣 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html#recharge" data-toggle="modal">
                    会员充值 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html#others" data-toggle="modal">
                    其他消费 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html#change" data-toggle="modal">
                    换卡补卡 </a></li>
        ...
        <li class="submenu"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#"> <i class="icon icon-financial"></i> <span>业务管理</span></a>
            <ul>
        ...
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/setting/frame.html#"> <i class="icon icon-th"></i> <span>门店管理</span></a>
            <ul>
                <li><a href="http://115.28.221.99/shopv3/html/shop/shopStatistics.html">
                    门店统计</a></li>
            </ul>
        </li>
        <li class="active submenu open"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#"> <i class="icon icon-cog"></i> <span>系统管理</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/setting/role.html">
                    角色管理</a></li>
                <li class="active"><a href="http://115.28.221.99/shopv3/html/shop/frame.html">
                    格架管理</a></li>
                <li><a href="http://115.28.221.99/shopv3/html/setting/code.html">
                    条形码管理</a></li>
        ...
        <div class="table_info_box member-topbg">
            <form class="form-inline" method="get">
                <div class="input-group">
                    <input type="text" name="search_EQ_orderId" id="orderId" class="form-control" autofocus="" placeholder="订单号">
                    <div class="select2-container" id="s2id_isUse" style="width: 100px">    <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" onclick="return false;" class="select2-choice">   <span>是否占用</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select style="display: none;width: 100px;" id="isUse" name="search_EQ_isUse">
                        <option selected="selected" value="-1">是否占用</option>
                        <option value="1">已占用</option>
                        <option value="0">未占用</option>
                    </select>
                        <span class="input-group-btn">
                            <button type="submit" class="btn btn-success"><i class="icon-search icon-white"></i>查 询
                            </button>
                        </span>
                </div>
            </form>
        </div>
        <div class="row-fluid" style="margin:10px 0px 0px 0;">
            <div class="span2">
                <button class="btn btn-sm btn-info" onclick="editFrame();">
                    修改格架
                </button>
            </div>
        </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        <span class="icon"> <i class="icon-th-list"></i> </span> <h5>格架列表</h5>
                    </div>
                        ...
                        <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen1">    <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table class="table table-hover data-table dataTable no-footer" id="DataTables_Table_0" role="grid">
                                ...
                                <tr role="row"><th class="sorting ui-state-default sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="
                                    ...
                                    ：激活排序的列降序" style="width: 111px;" aria-sort="ascending"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">
                                            <div class="DataTables_sort_wrapper">输送线<span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-n"></span>
                                            </div>
                                    ...
                                    ：激活排序列升序" style="width: 111px;"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">
                                    ...
                                    ：激活排序列升序" style="width: 159px;"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">
                                            <div class="DataTables_sort_wrapper">订单号<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                            </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th class="sorting ui-state-default" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="
                                    ...
                                    ：激活排序列升序" style="width: 169px;"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">
                                            <div class="DataTables_sort_wrapper">衣物条形码<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                            </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th class="sorting ui-state-default" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="
                                    ...
                                    ：激活排序列升序" style="width: 202px;"><div class="DataTables_sort_wrapper">
                                        <div class="DataTables_sort_wrapper">
                                ...
                                <tr role="row" class="odd">
                                    <td class="center sorting_1">135</td>
                                    <td class="center">1024</td>
                                    <td class="center"></td>
                                    <td class="center"></td>
                                    <td class="center">
                                        <a class="btn btn-primary" href="http://115.28.221.99/frameManage/edit?id=1024&amp;orderId=&amp;areaId=135&amp;isUse=">占用格架</a>
                                    </td>
                                </tr><tr role="row" class="even">
                                    <td class="center sorting_1">135</td>
                                    <td class="center">1280</td>
                                    <td class="center">JN206864</td>
                                    <td class="center">9197346</td>
                                    <td class="center">
                                        <a class="btn btn-warning" href="javascript:clear(&#39;1280&#39;,&#39;JN206864&#39;)">清空格架</a>
                                    </td>
                                </tr></tbody>
...
<!--修改格架-->
<div id="editframe" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form class="form-horizontal" method="post" action="http://115.28.221.99/frameManage/edit" id="inputForm">
        <div class="modal-header">
            <button data-dismiss="modal" class="close" type="button">×</button>
            <h3><i class="icon icon-plus-sign"></i>修改格架</h3>
        </div>
                ...
                <div class="ibox-title">
                    <fieldset>
                        <div class="control-group offset1">
                            <label class="control-label">格架数量</label>

                            <div class="controls">
                                <input type="text" value="" id="total" placeholder="" name="name" class="form-control"><span class="label label-success">格架占用数量：</span>
                                <span id="occupy">0</span>个
                            </div>
                        </div>
                        <div class="control-group offset1">
                            <label class="control-label">挂衣数量</label>

                            <div class="controls">
                                <input type="text" id="free" placeholder="" name="plainPassword" minlength="8" class="form-control">
                            </div>
                        </div>
                    </fieldset>
                </div>
        ...
        <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取消</a>
            <button class="btn btn-primary save" type="submit">保存</button>
        </div>
    </form>
</div>
<!--清空格架-->
<div id="myModal" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-footer">
                <a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取消</a>
                <a id="cleanOK" class="btn btn-sm btn-primary" href="javascript:void(0)" onclick="cleanOK();return true;">清空</a>
            </div>
...
<div id="member-message" class="modal hide fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div>
        <div class="modal-body">
            <ul class="nav nav-tabs" style="margin-bottom:15px;">
                <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#message" data-toggle="tab">会员信息</a>
                </li>
                <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#order-history" data-toggle="tab">订单记录</a></li>
                <li id="a"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#trade-history" data-toggle="tab">交易记录</a></li>
                <li id="2"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#service-visitback" data-toggle="tab">客服回访</a></li>
                <li id="3"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#order-appraise" data-toggle="tab">订单评价</a></li>
                <li id="4"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#member-feedback" data-toggle="tab">用户投诉</a></li>
                <li id="5"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#suggest" data-toggle="tab">APP反馈</a></li>
            </ul>
            <!--切换显示内容-->
            <div class="tab-content" id="submitForm">
                <!--会员信息-->
                <div class="row-fluid tab-pane active" id="message" style="margin-top:0px;">
                    <form action="http://115.28.221.99/shopv3/html/setting/frame.html#" method="get" class="form-horizontal">
                        <div class="span12">
                            <div class="span4">
                                ...
                                <div class="widget-box mt-0">
                                    ...
                                    <div class="widget-content">
                                        <table class="table table-in">
                                            ...
                                            <tr>
                                                <td> 优&nbsp;&nbsp;惠&nbsp;&nbsp;券</td>
                                                <td style="text-align:left"><span class="text-Voucher">0</span>元（0张） <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" data-toggle="collapse" data-target="#change" class="btn btn-mini">点击查看</a>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        ...
                                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen2">    <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table role="grid" id="DataTables_Table_0" class="table table-hover data-table  dataTable no-footer">
                                            ...
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#check-order" data-toggle="modal" v="114606" class="tab-link btgo">10090008</a></td>
                                                <td>王小啊</td>
                                                <td>131111111</td>
                                                <td>小王</td>
                                                <td>2</td>
                        ...
                        <div class="widget-content nopadding">
                            <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                ...
                                <table role="grid" id="DataTables_Table_0" class="table table-hover no-footer">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="http://115.28.221.99/shopv3/html/setting/frame.html#check-order" data-toggle="modal" v="114606" class="tab-link btgo">10090008</a></td>
                                        <td>王小啊</td>
                                        <td>131111111</td>
                                        <td>小王</td>
                                        <td>不错，不错，洗的挺好</td>
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取&nbsp;&nbsp;消</a></div>
</div>
<!--编辑条形码-->
<div id="barcode" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a class="btn btn-primary" href="javascript:;" id="export">确定</a> <a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取消</a></div>
</div>
&lt;<!--顾客取衣-->
                        ...
                        <div class="span12">
                            ...
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="btn-group pull-right" style="margin-top:6px; margin-right:6px;">
                                        <a href="http://115.28.221.99/shopv3/html/setting/frame.html#add-2" role="button" data-toggle="modal" class="btn  btn-danger" title="">补打小票</a>
                                        <a href="http://115.28.221.99/shopv3/html/setting/frame.html#leftmoney" role="button" data-toggle="modal" class="btn btn-success" title="">顾客取衣</a>
                                    </div>
                                </div>
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        ...
                                        <table role="grid" id="DataTables_Table_0" class="table table-hover  no-footer">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>有腰带</td>
                                                <td><a href="http://115.28.221.99/shopv3/html/setting/frame.html#order-flow" data-toggle="modal" v="114606" class="tab-link btgo">0090008</a></td>
                                                <td>普洗</td>
                                                <td>洗涤</td>
                                                <td>12</td>
                                            </tr>
...
<div id="part" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" href="http://115.28.221.99/shopv3/html/setting/frame.html#">确 定</a></div>
</div>
<!--确认付款-->
<div id="add-5" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" data-toggle="modal" href="http://115.28.221.99/shopv3/html/setting/frame.html#check-order">确 定</a>
    </div>
</div>
<!--欠款补齐页面-->
...
<div id="check-order" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div class="modal-body">
        <div class="row-fluid">
            <div class="span12">
                <div class="span3">
                    <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" data-toggle="modal" v="114606" style="margin-left:185px;" class="btn btn-success ">打印小票</a>
                ...
                <div class="span9">
                    <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" data-toggle="modal" v="114606" style="margin-left:765px;" class="btn btn-success ">打印条形码</a>
    ...
    <div class="modal-footer"><a class="btn btn-danger save" href="http://115.28.221.99/shopv3/html/setting/frame.html#order-refund" data-toggle="modal">退款</a><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取消</a>
    </div>
</div>
<!--订单在工厂状态-->
                                ...
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left"><span class="text-Voucher">2</span>元（1张）
                                            <a href="http://115.28.221.99/shopv3/html/setting/frame.html#" data-toggle="collapse" data-target="#change" class="btn btn-mini">点击查看</a>
                        ...
                        <div class="widget-box mt-0">
                            ...
                            <div style="margin-top: 10px;">
                                <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px">
                                    <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#clubcard" data-toggle="tab">会员卡</a>
                                    </li>
                                    <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#rechargecard" data-toggle="tab">充值卡</a>
                                    </li>
                                </ul>
                            </div>
                            <!--切换显示内容-->
                    ...
                    <div class="span12">
                        ...
                        <div class="span4">
                            <div class="widget-box mt-0">
                                ...
                                <div style="margin-top: 10px;">
                                    <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px;">
                                        <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#c" data-toggle="tab">换&nbsp;&nbsp;卡</a>
                                        </li>
                                        <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/setting/frame.html#b" data-toggle="tab">补&nbsp;&nbsp;卡</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--切换显示内容-->
...
<div id="order-refund" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn btgo" href="http://115.28.221.99/shopv3/html/setting/frame.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary del" href="http://115.28.221.99/shopv3/html/setting/frame.html#">确 定</a></div>
</div>

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0054)http://115.28.221.99/shopv3/html/business/receive.html -->
<html>
...
<div id="header">
    <h1><img src="./receive_files/logo.png"></h1>
</div>
<div id="topnav">
    <div class="navbar navbar-inverse">
        ...
        <div class="nav-collapse collapse">
            ...
            <ul class="nav">
                ...
                <a href="http://115.28.221.99/shopv3/html/business/receive.html#takeClothes" data-toggle="modal">
                    <li class=""><i class="icon icon-inbox"></i><span>顾客取衣</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/business/receive.html#recharge" data-toggle="modal">
                    <li class=""><i class="icon icon-user"></i><span>会员充值</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/business/receive.html#others" data-toggle="modal">
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group" style="width: auto; margin: 0px;">
        ...
        <li class="btn dropdown" id="edit-users"><a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="dropdown" data-target="#edit-users" class="dropdown-toggle"><i class="icon icon-user"></i> <span class="text">敖佳丽</span></a>
        </li>
...
<div id="sidebar">
    <ul style="display: block;">
        <li class="active submenu open"><a href="http://115.28.221.99/shopv3/html/business/receive.html#"> <i class="icon icon-check"></i> <span>日常业务</span></a>
            <ul>
                <li><a href="http://115.28.221.99/shopv3/html/business/newOrder.html">
                    收银台 </a></li>
                <li class="active"><a href="http://115.28.221.99/shopv3/html/business/receive.html">
                    接收衣物 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html#takeClothes" data-toggle="modal">
                    顾客取衣 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html#recharge" data-toggle="modal">
                    会员充值 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html#others" data-toggle="modal">
                    其他消费 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html#changes" data-toggle="modal">
                    换卡补卡 </a></li>
        ...
        <li class="submenu"><a href="http://115.28.221.99/shopv3/html/business/receive.html#"> <i class="icon icon-financial"></i> <span>业务管理</span></a>
            <ul>
        ...
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/business/receive.html#"> <i class="icon icon-th"></i> <span>统计管理</span></a>
            <ul>
        ...
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/business/receive.html#"> <i class="icon icon-cog"></i> <span>系统管理</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html">
                    格架管理</a></li>
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html#barcode" data-toggle="modal">
                    条形码管理</a></li>
...
<div id="content">
    <div class="container-fluid">
            ...
            <div class="form-group">
                <form action="http://115.28.221.99/outFactory/list" method="post" class="form-horizontal">
                    <div class="col-lg-4 m-l-n">
                        <input type="text" name="packageBarcodeOrOrderId" id="packageBarcodeOrOrderId" class="form-control" autofocus="" placeholder="条形码">
                                                    <span class="input-group-btn">
                                                        <button type="submit" class="btn btn-success" id="validate_btn">
                                                            接收衣物并上架
                                                        </button>
                                                        <button type="submit" class="btn btn-warning" id="validate_btn">
                                                            接收衣物不上架
                                                        </button>
                                                    </span>
                    </div>
        ...
        <div class="row-fluid" style="margin:10px auto;">
            <div class="span12">
                <div class="widget-title">
                    <span class="icon"> <i class="icon-th-list"></i> </span> <h5>订单号:16011220002 共3件衣物 , 2件未接收</h5>
                </div>
                        ...
                        <table role="grid" id="DataTables_Table_0" class="table table-hover no-footer">
                            ...
                            <tr role="row">
                                <th aria-label="订单编号：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                    <div class="DataTables_sort_wrapper">名称 <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                    </div>
                                </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="collapse" data-target="#info" title="" class="btn btn-danger">取消</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <div class="ibox-title" style="float:left; width:60%">
            <div>
                <span class="label label-info">已接收</span>
                已接收<span id="daichuchang">0</span>个订单
            </div>
            <table id="contentTable1" class="table table-striped table-bordered table-condensed   table-hover no-footer">
                <thead>
                <tr>
                    <td>交接单号</td>
                    <td>订单号</td>
                ...
                <tr>
                    ...
                    <td class="center">上衣</td>
                    <td class="center">10001010</td>
                    <td class="center">12</td>
                </tr>
                </tbody>
            </table>
        </div>
        <div class="ibox-title" style="float: right;width:40%">
            <div>
                <span class="label label-info">待接收</span>
                待接收<span id="daihecha">6</span>个订单
            </div>
            <table id="contentTable" class="table table-striped table-bordered table-condensed  table-hover no-footer">
                <thead>
                <tr>
                    <td>交接单号</td>
                    <td>订单号</td>
                ...
                <tr>
                    ...
                    <td class="center">上衣</td>
                    <td class="center">10001010</td>
                    <td class="center">2016-04-11 00:22</td>
                </tr>
                </tbody>
            </table>
        </div>
...
<!--提示1 该订单有附件-->
<div id="add-41" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3><i class="icon "></i> 提示！</h3>
    </div>
    <div class="modal-body">
        <p>该订单有附件***,请确保已返回门店？</p>
    </div>
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/business/receive.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" href="http://115.28.221.99/shopv3/html/business/receive.html#">确 定</a></div>
</div>
<!--提示1 订单衣物齐全-->
<div id="add-42" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3><i class="icon "></i> 提示！</h3>
    </div>
...
<div id="barcode" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a class="btn btn-primary" href="javascript:;" id="export">确定</a> <a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/business/receive.html#">取消</a></div>
</div>
&lt;<!--顾客取衣-->
<div id="takeClothes" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div>
        <div class="modal-body">
            <div class="row-fluid tab-pane" id="order-history">
                <div class="row-fluid">
                    <form action="http://115.28.221.99/shopv3/html/business/receive.html#" method="get" class="form-horizontal">
                        <div class="span12">
                            <div class="table_info_box member-topbg">
                            ...
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="btn-group pull-right" style="margin-top:6px; margin-right:6px;">
                                        <a href="http://115.28.221.99/shopv3/html/business/receive.html#add-2" role="button" data-toggle="modal" class="btn  btn-danger" title="">补打小票</a>
                                        <a href="http://115.28.221.99/shopv3/html/business/receive.html#leftmoney" role="button" data-toggle="modal" class="btn btn-success" title="">顾客取衣</a>
                                    </div>
                                </div>
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        ...
                                        <table role="grid" id="DataTables_Table_0" class="table table-hover  no-footer">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>有腰带</td>
                                                <td><a href="http://115.28.221.99/shopv3/html/business/receive.html#order-flow" data-toggle="modal" v="114606" class="tab-link btgo">0090008</a></td>
                                                <td>普洗</td>
                                                <td>洗涤</td>
                                                <td>12</td>
                                            </tr>
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/business/receive.html#">取&nbsp;&nbsp;消</a></div>
</div>
<!--部分取衣提示-->
...
<div id="add-5" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/business/receive.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" data-toggle="modal" href="http://115.28.221.99/shopv3/html/business/receive.html#check-order">确 定</a>
    </div>
</div>
<!--欠款补齐页面-->
...
<div id="check-order" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div class="modal-body">
        <div class="row-fluid">
            <div class="span12">
                <div class="span3">
                    <a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="modal" v="114606" style="margin-left:185px;" class="btn btn-success ">打印小票</a>
                ...
                <div class="span9">
                    <a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="modal" v="114606" style="margin-left:765px;" class="btn btn-success ">打印条形码</a>
    ...
    <div class="modal-footer"><a class="btn btn-danger save" href="http://115.28.221.99/shopv3/html/business/receive.html#order-refund" data-toggle="modal">退款</a><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/business/receive.html#">取消</a>
    </div>
</div>
<!--订单在工厂状态-->
                                ...
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left"><span class="text-Voucher">2</span>元（1张）
                                            <a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="collapse" data-target="#changeb" class="btn btn-mini">点击查看</a>
                        ...
                        <div class="widget-box mt-0">
                            ...
                            <div style="margin-top: 10px;">
                                <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px">
                                    <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/business/receive.html#clubcard" data-toggle="tab">会员卡</a>
                                    </li>
                                    <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/business/receive.html#rechargecard" data-toggle="tab">充值卡</a>
                                    </li>
                                </ul>
                            </div>
                            <!--切换显示内容-->
                            ...
                            <div class="widget-content">
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        <td> 优&nbsp;&nbsp;惠&nbsp;&nbsp;券</td>
                                        <td style="text-align:left"><span class="text-Voucher">2</span>元（1张）
                                            <a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="collapse" data-target="#changec" class="btn btn-mini">点击查看</a>
                    ...
                    <div class="span12">
                                ...
                                <div class="widget-content">
                                    <table class="table table-in">
                                        ...
                                        <tr>
                                            <td> 优&nbsp;&nbsp;惠&nbsp;&nbsp;券</td>
                                            <td style="text-align:left"><span class="text-Voucher">2</span>元（1张）
                                                <a href="http://115.28.221.99/shopv3/html/business/receive.html#" data-toggle="collapse" data-target="#changea" class="btn btn-mini">点击查看</a>
                        ...
                        <div class="span4">
                            <div class="widget-box mt-0">
                                ...
                                <div style="margin-top: 10px;">
                                    <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px;">
                                        <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/business/receive.html#c" data-toggle="tab">换&nbsp;&nbsp;卡</a>
                                        </li>
                                        <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/business/receive.html#b" data-toggle="tab">补&nbsp;&nbsp;卡</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--切换显示内容-->
...
<div id="order-refund" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn btgo" href="http://115.28.221.99/shopv3/html/business/receive.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary del" href="http://115.28.221.99/shopv3/html/business/receive.html#">确 定</a></div>
</div>

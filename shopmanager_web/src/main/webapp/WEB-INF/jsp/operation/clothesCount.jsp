...
<div id="header">
    <h1><img src="./clothesCount_files/logo.png"></h1>
</div>
<div id="topnav">
                                ...
                                <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen1">    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table role="grid" id="DataTables_Table_0" class="table table-hover data-table dataTable no-footer">
                                        ...
                                        <tr role="row"><th aria-label="
                                            ...
                                            ：激活排序列升序" style="width: 120px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">条形码 <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                格架号
                                                
                                            ：激活排序列升序" style="width: 83px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">格架号<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                下单时间
                                                
                                            ：激活排序列升序" style="width: 206px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">下单时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                操作
                                                
                                            ：激活排序列升序" style="width: 108px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                        ...
                                        <tr role="row" class="odd">
                                            <td class="sorting_1"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#check-order" data-toggle="modal">121221</a></td>
                                            <td>上衣</td>
                                            <td>00020003</td>
                                            <td>5</td>
                                    ...
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen2">    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table role="grid" id="DataTables_Table_0" class="table table-hover data-table dataTable no-footer">
                                        ...
                                        <tr role="row"><th aria-label="
                                            ...
                                            ：激活排序的列降序" style="width: 0px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default sorting_asc" aria-sort="ascending"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">盘点时间 <span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-n"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-n"></span></div></th><th aria-label="
                                                衣物数量
                                        ...
                                        <tr role="row" class="odd">
                                            <td class="sorting_1">2016-04-12</td>
                                            <td>50</td>
                                            <td>5</td>
                                            <td>5</td>
                                            <td>小王</td>
    ...
    <div class="modal-body">
        <form class="form-horizontal offset1" id="exportform" method="post">
                ...
                <div class="controls">
                    <div class="col-sm-10" style="width: 400px">
                        ...
                        <div class="checkbox i-checks" style="float: left;width: 130px">
                            ...
                            <div style="position: relative;" class="icheckbox_square-green"><div class="checker" id="uniform-undefined"><span><input style="position: absolute; opacity: 0;" value="162" name="areaId" type="checkbox"></span></div>
                        ...
                        <div class="checkbox i-checks" style="float: left;width: 130px">
                            ...
                            <div style="position: relative;" class="icheckbox_square-green"><div class="checker" id="uniform-undefined"><span><input style="position: absolute; opacity: 0;" value="163" name="areaId" type="checkbox"></span></div>
                                <ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins>
                            </div>
                            返回门店未上架
                        ...
                        <div class="checkbox i-checks" style="float: left;width: 130px">
                            ...
                            <div style="position: relative;" class="icheckbox_square-green"><div class="checker" id="uniform-undefined"><span><input style="position: absolute; opacity: 0;" value="164" name="areaId" type="checkbox"></span></div>
                                <ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins>
                            </div>
                            丢失
            ...
            <div class="control-group offset1">
                ...
                <div class="controls">
                    <div class="select2-container select-width" id="s2id_areaId2">    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" onclick="return false;" class="select2-choice">   <span>已处理</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select style="display: none;" name="search_EQ_areaId" id="areaId2" class="select-width">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        ...
                                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen5">    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table role="grid" id="DataTables_Table_0" class="table table-hover data-table  dataTable no-footer">
                                            ...
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#check-order" data-toggle="modal" v="114606" class="tab-link btgo">10090008</a></td>
                                                <td>王小啊</td>
                                                <td>131111111</td>
                                                <td>小王</td>
                                                <td>2</td>
                    ...
                    <div class="span12">
                        ...
                        <div class="span4">
                            <div class="widget-box mt-0">
                                ...
                                <div style="margin-top: 10px;">
                                    <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px;">
                                        <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#c" data-toggle="tab">换&nbsp;&nbsp;卡</a>
                                        </li>
                                        <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#b" data-toggle="tab">补&nbsp;&nbsp;卡</a>
                                        </li>
                                    </ul>
                                </div>
                                <!--切换显示内容-->
...
<div id="order-refund" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn btgo" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary del" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">确 定</a></div>
</div>
<script type="text/javascript">
    //修改格架
    function countOver() {
        $('#countOver').modal('show');
    }
</script>
<script>
    var currentId;
    var currentOrderId;
    var clear = function (id, orderId) {
        currentId = id;
    ...
    var areaId;
    var isUse;
    var cleanOK = function () {
        areaId = $("#areaId").val();
        isUse = $("#isUse").val();
        var deleteHref = "/frameManage/edit?id=" + currentId + "&orderId=" + currentOrderId + "&areaId=" + areaId + "&isUse=" + isUse;
        $("#cleanOK").attr("href", deleteHref);
    };
</script>
<script>
    $(function () {
        $('#areaId2').change(function () {
            ...
            alert("areaId=" + areaId);
            var url = "/frameManage/manage?areaId=" + areaId;
            $.ajax({
                url: url,
                type: "GET",
                success: function (json) {
                    $('#edit-4').modal('show');
                    $('#name2').attr('value', json.name);
                    $('#sort2').attr('value', json.sort);

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0060)http://115.28.221.99/shopv3/html/operation/clothesCount.html -->
<html>
<%@ include file="/WEB-INF/commons/head-commons.jsp" %>
<body class="pace-done mini-navbar">

<div id="header">
    <h1><img src="./clothesWarning_files/logo.png"></h1>
</div>
<div id="topnav">
    <div class="navbar navbar-inverse">
        ...
        <div class="nav-collapse collapse">
            ...
            <ul class="nav">
                ...
                <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#takeClothes" data-toggle="modal">
                    <li class=""><i class="icon icon-inbox"></i><span>顾客取衣</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#recharge" data-toggle="modal">
                    <li class=""><i class="icon icon-user"></i><span>会员充值</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#others" data-toggle="modal">
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group" style="width: auto; margin: 0px;">
        <li class="btn dropdown" id="edit-users">
            <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" data-toggle="dropdown" data-target="#edit-users" class="dropdown-toggle"><i class="icon icon-user"></i>
...
<div id="sidebar">
    <ul style="display: block;">
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#"> <i class="icon icon-check"></i> <span>日常业务</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html">
                    接收衣物 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#takeClothes" data-toggle="modal">
                    顾客取衣 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#recharge" data-toggle="modal">
                    会员充值 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#others" data-toggle="modal">
                    其他消费 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#changes" data-toggle="modal">
                    换卡补卡 </a></li>
        ...
        <li class="active submenu open"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#"> <i class="icon icon-financial"></i> <span>业务管理</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/operation/clothesWarning.html">
                    衣物预警 </a></li>
                <li class="active"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html">
                    衣物盘点</a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/orderNumber.html">
                    交接单 </a></li>
            </ul>
        </li>
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#"> <i class="icon icon-th"></i> <span>统计管理</span></a>
            <ul>
                <li><a href="http://115.28.221.99/shopv3/html/shop/shopStatistics.html">
                    门店统计</a></li>
            </ul>
        </li>
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#"> <i class="icon icon-cog"></i> <span>系统管理</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html">
                    格架管理</a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#barcode" data-toggle="modal">
                    条形码管理</a></li>
    ...
    <div class="container-fluid">
        <div>
            <ul id="PageLab" class="nav nav-tabs">
                <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#tab1" data-toggle="tab">衣物盘点</a></li>
                <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#tab2" data-toggle="tab">历史盘点记录</a></li>
            </ul>
        </div>
        <!--切换显示内容-->
        <div class="tab-content" id="submitForm">
            <!--衣物盘点-->
            <div class="row-fluid tab-pane active" id="tab1" style="margin-top:0px;">
                <div class="table_info_box member-topbg">

                    <input id="searchkey" placeholder="条形码" class="span3" type="text">
                    ...
                    <div id="s2id_cardtypeid" class="select2-container">
                        ...
                        <button class="btn btn-success" id="BTsearch"><i class="icon-search icon-white"></i> 扫描</button>
                        <button class="btn btn-danger" id="BTsearch" onclick="countOver();"> 盘点结束
                        </button>
                        <span>提示：1.条形码已盘点 2.条形码不能为空</span>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title">
                                <span class="icon"> <i class="icon-th-list"></i> </span> <h5>衣物盘点: 共3件衣物</h5>
                            </div>
                            <div class="widget-content nopadding">
                                <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                    <table role="grid" id="DataTables_Table_0" class="table table-hover data-table dataTable no-footer">
                                        <thead>
                                        <tr role="row">
                                            <th aria-label="类型：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                            ...
                                            <th aria-label="金额：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">衣物名称<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="类型：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">条形码 <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="金额：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                                            ...
                                            <th aria-label="创建时间：激活排序列升序" style="width: 74px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">下单时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="操作：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#check-order" data-toggle="modal">121221</a></td>
                                            <td>上衣</td>
                                            <td>00020003</td>
                                            <td>5</td>
                                            <td>2016-04-12 21:19</td>
                                            <td>
                                                <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" v="114606" data-toggle="modal" class="btn btn-danger btgo ">取消</a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            <div id="tab2" class="tab-pane">
                <div class="table_info_box member-topbg">
                    <div id="s2id_cardtypeid" class="select2-container">
                        ...
                        <div id="searchdate" class="btn date-inline selectdate" style="margin-left:0"><i class="icon-calendar"></i>
                            <b class="caret"></b></div>
                            ...
                            <div class="widget-content nopadding">
                                <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                    <table role="grid" id="DataTables_Table_0" class="table table-hover data-table dataTable no-footer">
                                        ...
                                        <tr role="row">
                                            <th aria-label="类型：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">盘点时间 <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="金额：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                                            ...
                                            <th aria-label="创建时间：激活排序列升序" style="width: 74px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">盘亏衣物<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="创建时间：激活排序列升序" style="width: 74px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">盘盈衣物<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="创建时间：激活排序列升序" style="width: 74px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">盘点人<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            </th>
                                            <th aria-label="操作：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                                                <div class="DataTables_sort_wrapper">操作<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        ...
                                        <tr>
                                            ...
                                            <td>5</td>
                                            <td>小王</td>
                                            <td><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#result" data-toggle="modal" v="114606" class="btn btn-primary btgo">详情</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
...
<!--盘点结束-->
<div id="countOver" class="modal hide fade modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3><i class="icon icon-plus-sign"></i>盘点结束</h3>
    </div>
    <div class="modal-body">
        <p>是否结束本次盘点？</p>
    </div>
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取消</a>
        <a data-dismiss="modal" data-toggle="modal" class="btn btn-primary del" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#result">确 定</a>
    </div>
</div>
<!--盘点结果-->
<div id="result" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3><i class="icon icon-plus-sign"></i>盘点结果</h3>
    </div>
    <div class="modal-body">
        <div class="row-fluid">
            <form action="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" method="get" class="form-horizontal">
                <div class="span12">
                    <div class="table_info_box member-topbg">
                        ...
                        <button class="btn btn-success" id="BTsearch"><i class="icon-search icon-white"></i> 扫描
                        </button>
                    </div>
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="widget-box">
                                <div class="widget-title">
                                    <span class="icon"> <i class="icon-th-list"></i> </span> <h5 style="color:red;">
                                    盘亏衣物列表</h5><h5>共3件衣物</h5>
                                </div>
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        <table role="grid" id="DataTables_Table_0" class="table table-hover data-table dataTable no-footer">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#handle" v="114606" data-toggle="modal" class="btn btn-danger btgo ">处理</a></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取&nbsp;&nbsp;消</a></div>
</div>
<!--处理-->
<div id="handle" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3><i class="icon icon-plus-sign"></i>　处理</h3>
    </div>
    <div class="modal-body">
        <form class="form-horizontal offset1" id="exportform" method="post">
                ...
                <div class="controls">
                    <div class="col-sm-10" style="width: 400px">
                        ...
                        <div class="checkbox i-checks" style="float: left;width: 130px">
                            ...
                            <div style="position: relative;" class="icheckbox_square-green"><input style="position: absolute; opacity: 0;" value="162" name="areaId" type="checkbox">
                        ...
                        <div class="checkbox i-checks" style="float: left;width: 130px">
                            ...
                            <div style="position: relative;" class="icheckbox_square-green"><input style="position: absolute; opacity: 0;" value="163" name="areaId" type="checkbox">
                                <ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins>
                            </div>
                            返回门店未上架
                        ...
                        <div class="checkbox i-checks" style="float: left;width: 130px">
                            ...
                            <div style="position: relative;" class="icheckbox_square-green"><input style="position: absolute; opacity: 0;" value="164" name="areaId" type="checkbox">
                                <ins style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;" class="iCheck-helper"></ins>
                            </div>
                            丢失
            ...
            <div class="control-group offset1">
                ...
                <div class="controls">
                    <select style="display: none;" name="search_EQ_areaId" id="areaId2" class="select-width">

                        <option value="4">已处理</option>

                        <option value="153">未处理</option>
            ...
            <div class="control-group offset1">
                ...
                <div class="controls">
                    <textarea class="" name="account" id="account"></textarea>
                </div>

            </div>
        </form>
    </div>
    <div class="modal-footer"><a class="btn btn-primary" href="javascript:;" id="export">确定</a> <a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取消</a></div>
</div>
<!--整体页面结束，以下是弹出窗口-->
<!--会员详情-->
    ...
    <div>
        <div class="modal-body">
            <ul class="nav nav-tabs" style="margin-bottom:15px;">
                <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#message" data-toggle="tab">会员信息</a>
                </li>
                <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#order-history" data-toggle="tab">订单记录</a></li>
                <li id="a"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#trade-history" data-toggle="tab">交易记录</a></li>
                <li id="2"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#service-visitback" data-toggle="tab">客服回访</a></li>
                <li id="3"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#order-appraise" data-toggle="tab">订单评价</a></li>
                <li id="4"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#member-feedback" data-toggle="tab">用户投诉</a></li>
                <li id="5"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#suggest" data-toggle="tab">APP反馈</a></li>
            </ul>
            <!--切换显示内容-->
            <div class="tab-content" id="submitForm">
                <!--会员信息-->
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px;">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span class=""><input name="roleId" onclick="setSelectAll();" value="2" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>经常下单
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span class=""><input name="roleId" onclick="setSelectAll();" value="6" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>其他
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="7" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>VIP
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="9" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>用户很麻烦
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="10" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>黑名单
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="11" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>竞争对手
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="12" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>测试
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="13" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>内部员工
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="14" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>领导
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="checkbox i-checks" style="float: left;width: 130px">
                                                            <label>
                                                                <div id="uniform-undefined" class="checker"><span><input name="roleId" onclick="setSelectAll();" value="15" style="opacity: 0;" type="checkbox"></span>
                                                                </div>
                                                                <i></i>大客户
                                                            </label>
                                                        </div>
                                ...
                                <div class="widget-box mt-0">
                                    ...
                                    <div class="widget-content">
                                        <table class="table table-in">
                                            ...
                                            <tr>
                                                <td> 优&nbsp;&nbsp;惠&nbsp;&nbsp;券</td>
                                                <td style="text-align:left"><span class="text-Voucher">0</span>元（0张） <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" data-toggle="collapse" data-target="#change" class="btn btn-mini">点击查看</a>
                                        ...
                                        <table role="grid" id="DataTables_Table_0" class="table table-hover data-table  dataTable no-footer">
                                            ...
                                            <tr role="row">
                                                ...
                                                <th aria-sort="descending" aria-label="条形码：激活排序列升序" style="width: 131px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="defaultsort sorting ui-state-default sorting_desc">
                                                    <div class="DataTables_sort_wrapper">送衣时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-s"></span>
                                                    </div>
                                                </th>
                                                ...
                                                <th aria-sort="descending" aria-label="门店：激活排序列升序" style="width: 131px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="defaultsort sorting ui-state-default sorting_desc">
                                                    <div class="DataTables_sort_wrapper">备注<span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-s"></span>
                                                    </div>
                                                </th>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                <td><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#check-order" data-toggle="modal" v="114606" class="tab-link btgo">10090008</a></td>
                                                <td>王小啊</td>
                                                <td>131111111</td>
                                                <td>小王</td>
                                                <td>2</td>
                    ...
                    <div class="widget-content nopadding">
                        <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                            ...
                            <table role="grid" id="DataTables_Table_0" class="table table-hover data-table  dataTable no-footer">
                                <thead>
                                <tr role="row">
                                    <th aria-label="订单编号：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">ID <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="用户姓名  ：激活排序列升序" style="width: 93px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">交易类型<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="手机号码：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">金额<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="卡类：激活排序列升序" style="width: 94px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">赠送金额<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="应收金额：激活排序列升序" style="width: 50px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">支付方式<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="实收金额：激活排序列升序" style="width: 50px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">交易来源<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="数量：激活排序列升序" style="width: 55px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">创建时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="状态：激活排序列升序" style="width: 28px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="i&quot;DataTables_sort_wrapper&quot;">状态<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                    <th aria-label="下单时间：激活排序列升序" style="width: 74px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default">
                                        <div class="DataTables_sort_wrapper">备注<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                        </div>
                                    </th>
                                ...
                                <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                    <table role="grid" id="DataTables_Table_0" class="table table-hover data-table  dataTable no-footer">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th aria-sort="descending" aria-label="条形码：激活排序列升序" style="width: 131px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="defaultsort sorting ui-state-default sorting_desc">
                                                <div class="DataTables_sort_wrapper">回访时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-s"></span>
                                                </div>
                                            </th>
                                        </tr>
                                        </thead>
                    ...
                    <div class="span12">
                        <div class="widget-content nopadding">
                            <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrappe">
                                <table role="grid" id="DataTables_Table_" class="table table-hover data-table dataTable no-footer">
                                    <thead>
                                    <tr role="row">
                                        ...
                                        <th aria-label="赠送金额：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                                            <div class="DataTables_sort_wrapper">反馈内容<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                            </div>
                                        </th>
                                        <th aria-label="折扣：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default">
                        ...
                        <div class="span12">
                            ...
                            <div class="widget-box">
                                <div class="widget-title">
                                    ...
                                    <div class="btn-group pull-right" style="margin-top:6px; margin-right:6px;">
                                        <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#add-2" role="button" data-toggle="modal" class="btn  btn-danger" title="">补打小票</a>
                                        <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#leftmoney" role="button" data-toggle="modal" class="btn btn-success" title="">顾客取衣</a>
                                    </div>
                                </div>
                                <div class="widget-content nopadding">
                                    <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                        ...
                                        <table role="grid" id="DataTables_Table_0" class="table table-hover  no-footer">
                                            ...
                                            <tr role="row">
                                                <th class="sorting ui-state-default sorting_asc" tabindex="0" aria-controls="tblist" rowspan="1" colspan="1" aria-label="：激活排序的列降序" style="width: 62px; " aria-sort="ascending">
                                                    <div class="DataTables_sort_wrapper">
                                                        <div class="DataTables_sort_wrapper">
                                                            <div class="checker" id="uniform-chkAll"><span><div class="checker" id="uniform-chkAll"><span><input type="checkbox" id="chkAll" name="chkAll" style="opacity: 0; "></span></div></span></div>
                                            ...
                                            <tr>
                                                <td class="sorting_1">
                                                    <div class="checker" id="uniform-undefined"><span><div class="checker" id="uniform-undefined"><span><input type="checkbox" class="chk" title="裤子" value="24068" style="opacity: 0; "></span></div></span></div>
                                                </td>
                                                <td>裤子</td>
                                                <td>9.0</td>
                                                <td>红色</td>
                                                <td></td>
                                                <td>有腰带</td>
                                                <td><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#order-flow" data-toggle="modal" v="114606" class="tab-link btgo">0090008</a></td>
                                                <td>普洗</td>
                                                <td>洗涤</td>
                                                <td>12</td>
                                            </tr>
...
<div id="part" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">确 定</a></div>
</div>
<!--确认付款-->
<div id="add-5" class="modal hide modal-mini" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取 消</a> <a data-dismiss="modal" class="btn btn-primary" data-toggle="modal" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#check-order">确 定</a>
    </div>
</div>
<!--欠款补齐页面-->
...
<div id="check-order" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div class="modal-body">
        <div class="row-fluid">
            <div class="span12">
                <div class="span3">
                    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" data-toggle="modal" v="114606" style="margin-left:185px;" class="btn btn-success ">打印小票</a>
                ...
                <div class="span9">
                    <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" data-toggle="modal" v="114606" style="margin-left:765px;" class="btn btn-success ">打印条形码</a>
    ...
    <div class="modal-footer"><a class="btn btn-danger save" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#order-refund" data-toggle="modal">退款</a><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#">取消</a>
    </div>
</div>
<!--订单在工厂状态-->
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left">
                                            <div class="control-group">
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px;">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span class=""><input name="roleId" onclick="setSelectAll();" value="2" style="opacity: 0;" readonly="readonly" type="checkbox"></span>
                                                        </div>
                                                        <i></i>经常下单
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span class=""><input name="roleId" onclick="setSelectAll();" readonly="readonly" value="6" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>其他
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input readonly="readonly" name="roleId" onclick="setSelectAll();" value="7" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>VIP
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input name="roleId" readonly="readonly" onclick="setSelectAll();" value="9" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>用户很麻烦
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input name="roleId" readonly="readonly" onclick="setSelectAll();" value="10" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>黑名单
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input name="roleId" readonly="readonly" onclick="setSelectAll();" value="12" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>测试
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input name="roleId" readonly="readonly" onclick="setSelectAll();" value="13" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>内部员工
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input name="roleId" readonly="readonly" onclick="setSelectAll();" value="14" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>领导
                                                    </label>
                                                </div>
                                                ...
                                                <div class="checkbox i-checks" style="float: left;width: 130px">
                                                    <label>
                                                        <div id="uniform-undefined" class="checker"><span><input name="roleId" readonly="readonly" onclick="setSelectAll();" value="15" style="opacity: 0;" type="checkbox"></span>
                                                        </div>
                                                        <i></i>大客户
                                                    </label>
                                                </div>
                                ...
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left"><span class="text-Voucher">2</span>元（1张）
                                            <a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#" data-toggle="collapse" data-target="#change" class="btn btn-mini">点击查看</a>
                        ...
                        <div class="widget-box mt-0">
                            ...
                            <div style="margin-top: 10px;">
                                <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px">
                                    <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#clubcard" data-toggle="tab">会员卡</a>
                                    </li>
                                    <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/operation/clothesCount.html#rechargecard" data-toggle="tab">充值卡</a>
                                    </li>
                                </ul>
                            </div>
                            <!--切换显示内容-->
                            <div class="tab-content" id="">
                                ...
                                <div class="row-fluid tab-pane active" id="clubcard" style="margin-top:0px;">
                                    ...
                                    <div class="controls">
                                        <select id="levelid" name="levelid" style="display: none;width: 150px; ">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:left">
                                                <div class="control-group">
                                                    ...
                                                    <div class="checkbox i-checks" style="float: left;width: 130px">
                                                        <label>
                                                            <div id="uniform-undefined" class="checker"><span></span></div></label></div></div></td></tr></tbody></table></div></div></div></div></form></div></div></div></div></body></html>
...
<!-- saved from url=(0052)http://115.28.221.99/shopv3/html/operation/card.html -->
<html class="w3c"><!--<![endif]--><!-- container-fluid -->
<%@ include file="/WEB-INF/commons/head-commons.jsp" %>
<body>

<div id="header">
    <h1><img src="./card_files/logo.png"></h1>
</div>
<div id="topnav">
    <div class="navbar navbar-inverse">
        ...
        <div class="nav-collapse collapse">
            ...
            <ul class="nav">
                ...
                <a href="http://115.28.221.99/shopv3/html/operation/card.html#takeClothes" data-toggle="modal">
                    <li class=""><i class="icon icon-inbox"></i><span>顾客取衣</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/operation/card.html#recharge" data-toggle="modal">
                    <li class=""><i class="icon icon-user"></i><span>会员充值</span></li>
                </a>
                <a href="http://115.28.221.99/shopv3/html/operation/card.html#others" data-toggle="modal">
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav btn-group" style="width: auto; margin: 0px;">
        ...
        <li class="btn dropdown" id="edit-users"><a href="http://115.28.221.99/shopv3/html/operation/card.html#" data-toggle="dropdown" data-target="#edit-users" class="dropdown-toggle"><i class="icon icon-user"></i> <span class="text">敖佳丽</span></a>
        </li>
...
<div id="sidebar">
    <ul style="display: block;">
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/operation/card.html#"> <i class="icon icon-check"></i> <span>日常业务</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/business/receive.html">
                    接收衣物 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/card.html#takeClothes" data-toggle="modal">
                    顾客取衣 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/card.html#recharge" data-toggle="modal">
                    会员充值 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/card.html#others" data-toggle="modal">
                    其他消费 </a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/card.html#change" data-toggle="modal">
                    换卡补卡 </a></li>
        ...
        <li class="active submenu open"><a href="http://115.28.221.99/shopv3/html/operation/card.html#"> <i class="icon icon-financial"></i> <span>业务管理</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/operation/memberCard.html">
                    会员卡管理 </a></li>
                <li class="active"><a href="http://115.28.221.99/shopv3/html/operation/card.html">
                    充值卡管理 </a></li>
        ...
        <li class=" submenu "><a href="http://115.28.221.99/shopv3/html/operation/card.html#"> <i class="icon icon-th"></i> <span>统计管理</span></a>
            <ul>
        ...
        <li class="submenu "><a href="http://115.28.221.99/shopv3/html/operation/card.html#"> <i class="icon icon-cog"></i> <span>系统管理</span></a>
            <ul>
                ...
                <li><a href="http://115.28.221.99/shopv3/html/setting/frame.html">
                    格架管理</a></li>
                <li><a href="http://115.28.221.99/shopv3/html/operation/card.html#barcode" data-toggle="modal">
                    条形码管理</a></li>
    ...
    <div class="container-fluid">
        <div>
            <ul id="PageLab" class="nav nav-tabs">
                <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/card.html#visitback" data-toggle="tab">充值卡列表</a></li>
        ...
        <div class="tab-content" id="submitForm">
            ...
            <div class="row-fluid tab-pane active" id="visitback" style="margin-top:0px;">
                <div class="table_info_box member-topbg">
                    ...
                    <div class="select2-container" id="s2id_levelid" style="width: 100px">    <a href="http://115.28.221.99/shopv3/html/operation/card.html#" onclick="return false;" class="select2-choice">   <span> 是否售卡</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select id="levelid" style="width: 100px; display: none; ">
                        <option value="0" selected=""> 是否售卡</option>
                        <option value="1"> 已售卡</option>
                        <option value="1"> 未售卡</option>
                    </select>
                    <div class="select2-container" id="s2id_levelid" style="width: 100px">    <a href="http://115.28.221.99/shopv3/html/operation/card.html#" onclick="return false;" class="select2-choice">   <span> 是否充值</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select id="levelid" style="width: 100px; display: none; ">
                        <option value="0" selected=""> 是否充值</option>
                    ...
                    <div class="btn-group pull-right">
                        <a href="http://115.28.221.99/shopv3/html/operation/card.html#add-3" role="button" data-toggle="modal" class="btn" title="导出会员资料，需管理员提供授权码"><i class="icon-print"></i>导出备份</a>
                    </div>
                </div>
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title"><span class="icon"><i class="icon-th-list"></i></span>
                                <h5>充值卡列表<span style="font-size: 12px;">：共0张充值卡 </span></h5>
                            </div>
                                ...
                                <div class="dataTables_wrapper no-footer" id="DataTables_Table_0_wrapper">
                                    ...
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer"><div class=""><div class="dataTables_length" id="DataTables_Table_0_length"><label><div class="select2-container" id="s2id_autogen1">    <a href="http://115.28.221.99/shopv3/html/operation/card.html#" onclick="return false;" class="select2-choice">   <span>25</span><abbr class="select2-search-choice-close" style="display:none;"></abbr>   <div><b></b></div></a>    <div class="select2-drop select2-offscreen">   <div class="select2-search">       <input type="text" autocomplete="off" class="select2-input" tabindex="0">   </div>   <ul class="select2-results">   </ul></div></div><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="" style="display: none;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></label></div></div><table role="grid" id="DataTables_Table_0" class="table  table-hover data-table dataTable no-footer">
                                        ...
                                        <tr role="row"><th aria-label="
                                            ...
                                            ：激活排序的列降序" style="width: 44px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default sorting_asc" aria-sort="ascending"><div class="DataTables_sort_wrapper">
                                            ...
                                            ：激活排序列升序" style="width: 79px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                            ...
                                            ：激活排序列升序" style="width: 28px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">金额<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                赠送金额
                                                
                                            ：激活排序列升序" style="width: 55px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">赠送金额<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                用户名
                                                
                                            ：激活排序列升序" style="width: 42px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                            ...
                                            ：激活排序列升序" style="width: 55px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">是否充值<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                充值时间
                                                
                                            ：激活排序列升序" style="width: 114px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">充值时间<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                售卡人
                                                
                                            ：激活排序列升序" style="width: 42px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                                <div class="DataTables_sort_wrapper">售卡人<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                </div>
                                            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span></div></th><th aria-label="
                                                来源
                                            ...
                                            ：激活排序列升序" style="width: 78px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" class="span2 sorting ui-state-default"><div class="DataTables_sort_wrapper">
                                        ...
                                        <tr role="row" class="odd">
                                            <td class="sorting_1">20元卡</td>
                                            <td>1234567890</td>
                                            <td>29.0</td>
                                            <td>0.0</td>
                                            <td>小王</td>
                                            <td><a href="http://115.28.221.99/shopv3/html/operation/card.html#member-message" data-toggle="modal">131221211</a></td>
                                            <td>已充值</td>
                                            <td>2016-03-25 11:24</td>
                                            <td>小王</td>
                                            <td>高新店</td>
                                            <td><button class="btn">已售卡</button></td>
                                            ...
                                            <td></td>
                                            <td>高新店</td>
                                            <td><a class="btn btn-success" href="http://115.28.221.99/shopv3/html/operation/card.html#rechargex" data-toggle="modal">售&nbsp;&nbsp;卡</a></td>
                                        </tr></tbody>
...
<!--售卡-->
<div id="rechargex" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:90%; margin-left:-45%;">
    ...
    <div class="modal-body">
        ...
        <div class="row-fluid tab-pane active" id="" style="margin-top:10px;">
            <form action="http://115.28.221.99/shopv3/html/operation/card.html#" method="get" class="form-horizontal">
                <div class="span12">
                    <div class="span4">
                        <div class="widget-box mt-0">
                            ...
                            <div class="widget-content">
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        <td> 手机号码</td>
                                        <td style="text-align:left"><input class="span10" name="phone" readonly="readonly" value="" type="text">
                                            <input class="span12" name="oldphone" value="" type="hidden">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="70px">客户姓名</td>
                                        <td style="text-align:left"><input class="span10" name="truename" readonly="readonly" value="" type="text"></td>
                                    </tr>

                                    <tr>
                                        <td> 支付密码</td>
                                        <td style="text-align:left">
                                            <input class="span10" name="oldphone" value="" readonly="readonly" type="password"><input class="span10" name="oldphone" value="" type="hidden">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> 确认密码</td>
                                        <td style="text-align:left">
                                            <input class="span10" name="oldphone" value="" readonly="readonly" type="password"><input class="span12" name="oldphone" value="111131312" type="hidden">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>会员标注</td>
                            ...
                            <div class="widget-content">
                                <table class="table table-in">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:left"><span class="text-Member"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>会员类型</td>
                                        <td style="text-align:left"><span class="text-Arrears"></span>&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="70px"> 会员卡余额</td>
                                        <td style="text-align:left"><span class="text-Member"></span>元
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>充值卡余额</td>
                                        <td style="text-align:left"><span class="text-Arrears"></span>元
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td> 优&nbsp;&nbsp;惠&nbsp;&nbsp;券</td>
                                        <td style="text-align:left"><span class="text-Voucher">0</span>元（0张）
                                            <a href="http://115.28.221.99/shopv3/html/operation/card.html#" data-toggle="collapse" data-target="#change" class="btn btn-mini">点击查看</a>
                        ...
                        <div class="widget-box mt-0">
                            ...
                            <div style="margin-top: 10px;">
                                <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px">
                                    <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/card.html#clubcard" data-toggle="tab">充值卡</a>
                                    </li>
                                </ul>
                            </div>
                            <!--切换显示内容-->
                            <div class="tab-content" id="">
                                <!--充值卡-->
                                <div class="row-fluid tab-pane active" id="" style="margin-top:0px;">
                                    <label class="control-label">卡号</label>

                                    <div class="controls">
                                        <input type="text" name="name" id="name" readonly="readonly" value="23232424324">
                                    </div>
                                    ...
                                    <div class="btn-group pull-right" style="margin-bottom:6px; margin-right:6px;">
                                        <button id="save_base_info" type="button" class="btn btn-small btn-success">售卡
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-footer"><a data-dismiss="modal" class="btn" href="http://115.28.221.99/shopv3/html/operation/card.html#">取&nbsp;&nbsp;消</a></div>
</div>
<!--充值-->
                ...
                <div class="span12">
                    ...
                    <div class="span4">
                        <div class="widget-box mt-0">
                            ...
                            <div style="margin-top: 10px;">
                                <ul class="nav nav-tabs" style="margin-bottom:15px;margin-left: 10px">
                                    <li id="ServiceLab" class="active"><a href="http://115.28.221.99/shopv3/html/operation/card.html#clubcard" data-toggle="tab">会员卡</a>
                                    </li>
                                    <li id="GoodsLab"><a href="http://115.28.221.99/shopv3/html/operation/card.html#rechargecard" data-toggle="tab">充值卡</a>
                                    </li>
                                </ul>
                            </div>
                            <!--切换显示内容-->
                            <div class="tab-content" id="">
                                ...
                                <div class="row-fluid tab-pane" id="rechargecard" style="margin-top:0px;">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="name" id="name" value="23232424324">
                                    </div>
                                    <label class="control-label">卡密</label>

...
!function ($, moment) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      ...
                      '<input class="input-small" type="text" name="daterangepicker_start" value="YYYY/MM/DD" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +
                      '<label for="daterangepicker_end"></label>' +
                      '<input class="input-small" type="text" name="daterangepicker_end" value="YYYY-MM-DD" disabled="disabled" />' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        outsideClick: function (e) {
			...
			if(mousePos.y > offset.top && mousePos.y<(offset.top+230) &&
				mousePos.x > offset.left && mousePos.x<(offset.left+277)
			){
				return;
			}

...
(function(e, g) {
    function i(a, b) {
        ...
        if (a.constructor === String)
            for (; c < d; c += 1) {
                if (0 === a.localeCompare(b[c]))
                    return c
            } else 
                for (; c < d; c += 1)
                    if (j = b[c], j.constructor === String) {
                        if (0 === j.localeCompare(a))
                            return c
                    } else if (j === a)
                        return c;
        return - 1
    ...
    if (window.Select2 === g) {
        ...
        w = x(Object, {
            ...
            highlight: function(a) {
                ...
                if (0 === arguments.length)
                    return i(b.filter(".select2-highlighted")[0], b.get());
            ...
            highlightUnderEvent: function(a) {
                ...
                if (0 < a.length&&!a.is(".select2-highlighted")) {
                    ...
                    0 == a.length && this.results.find(".select2-highlighted").removeClass("select2-highlighted")
            },
                    ...
                    if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                        ...
                        if (a !== g) {
                            ...
                            for (f = a.length; d < f; d += 1)
                                if (c = a[d].replace(/\s/g, "").match(/width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/), null !== c && 1 <= c.length)
                                    return c[1]
                        }
                        return "resolve" ===
        ...
        y = x(w, {
                    ...
                    if (this.enabled)
                        if (a.which === f.PAGE_UP || a.which === f.PAGE_DOWN)
                            ...
                            case f.ESC:
                                ...
                                a.which === f.TAB || f.isControl(a) || f.isFunctionKey(a) || a.which === f.ESC ||!1 ===
            ...
            postprocessResults: function(a, b) {
                ...
                this.results.find(".select2-result-selectable").each2(function(a, b) {
                    if (m(d.id(b.data("select2-data")), d.opts.element.val()))
                        return c = a, !1
                });
                this.highlight(c);
            ...
            val: function() {
                ...
                a = arguments[0];
                if (this.select)
                    this.select.val(a).find(":selected").each2(function(a, c) {
                        b = {
                            id: c.attr("value"),
                            text: c.text()
                        };
            ...
            data: function(a) {
                var b;
                if (0 === arguments.length)
                    return b = this.selection.data("select2-data"), b == g && (b = null), b;
        ...
        z = x(w, {
                ...
                this.search.bind("keydown", this.bind(function(b) {
                    if (this.enabled) {
                        ...
                        f.BACKSPACE && "" === this.search.val()) {
                            ...
                            a.find(".select2-search-choice-focus").removeClass("select2-search-choice-focus");
                        if (this.opened())
                            switch (b.which) {
                            case f.UP:
                            case f.DOWN:
                        ...
                        if (!(b.which === f.TAB || f.isControl(b) || f.isFunctionKey(b) || b.which === f.BACKSPACE || b.which === f.ESC)&&!(!1 === this.opts.openOnEnter && b.which === f.ENTER))
                            this.open(), (b.which === f.PAGE_UP || b.which === f.PAGE_DOWN) && l(b)
                    }
                }));
            ...
            getVal: function() {
                var a;
                if (this.select)
                    return a = this.select.val(), null === a ? [] : a;
        ...
        e.fn.select2 = function() {
            ...
            this.each(function() {
                if (0 === a.length || "object" === typeof a[0])
                    b = 0 === a.length ? {} : e.extend({}, a[0]), b.element = e(this), "select" === b.element.get(0).tagName.toLowerCase() ? f = b.element.attr("multiple") : (f = b.multiple ||!1, "tags"in b && (b.multiple = f=!0)), c = f ? new z : new y, c.init(b);
                else if ("string" === typeof a[0]) {
                    if (0 > i(a[0], h))
                        throw "Unknown method: " + a[0];
                    d = g;
                    c = e(this).data("select2");
                    if (c !== g && (d = "container" === a[0] ? c.container : c[a[0]].apply(c, a.slice(1)), d !== g))
                        return !1
                } else 
